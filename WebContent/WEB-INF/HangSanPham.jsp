...
<body>
    ...
    <div class="main-container">
        <div class="func-container">
         	<form action="${pageContext.request.contextPath}/HangSanPham" method="get">
            ...
            <a href="${pageContext.request.contextPath}/HangSanPham/ThemHangSanPham" class="func-btn nav-item">Thêm</a>
            <a href="${pageContext.request.contextPath}/HangSanPham" class="func-btn nav-item">Làm mới</a>
        </div>
        <hr>
        <div class="main-content">
            <table id="manufs" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        <th>Hãng sản phẩm</th>
                        <th></th>
                ...
                <tbody>
                	<c:forEach var="manuf" items="${manufs}">
	                    <tr>
	                        <td>${manuf.name}</td>
	                        <td>
	                            <button type="button" class="del-btn sub-func-btn" onclick="delManuf('${manuf.id}')">Xóa</button>
	                            <a href="${pageContext.request.contextPath}/HangSanPham/SuaHangSanPham?manufId=${manuf.id}" class="update-btn sub-func-btn">Sửa</a>
	                        </td>
	                    </tr>
                	</c:forEach>
                </tbody>
    ...
    <script>
        function delManuf(manufId) {
            if (window.confirm("Bạn chắc chắn muốn xóa?")) {
                window.location = "${pageContext.request.contextPath}/HangSanPham/XoaHangSanPham?manufId=" + manufId;
            }
        }
    </script>

	<c:if test="${deleteManufError == true}">
	    <script>
