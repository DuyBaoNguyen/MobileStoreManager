...
<body>
    <div class="left-menu-container">
        ...
        <div class="left-menu-content">
            <div class="left-menu">
                ...
                <div class="panel">
                    <div class="menu-item-container">
                        <a href="${pageContext.request.contextPath}/DonHangChuaThanhToan" class="menu-item" id="active-item">
                            Chưa thanh toán
                        </a>
            ...
            <form action="${pageContext.request.contextPath}/SuaDonHang" method="get">
                <div class="left-container container-item">
                    <div class="order section-item">
                        ...
                        <input type="text" name="personName" value="${order.personName}" required autocomplete="off">
                        <p class="sub-title">Số điện thoại</p>
                        <input type="text" name="personPhone" value="${order.personPhone}" required autocomplete="off">
                        <br>
                        <label>
                            <input type="radio" name="personSex" value="male"
                        ...
                        <label>
                            <input type="radio" name="personSex" value="female"
                        ...
                        <input type="submit" class="func-btn save-btn" value="Lưu">
                        <button type="button" class="func-btn del-btn" onclick="delOrder()">Xóa</button>
                        
                        <a href="${pageContext.request.contextPath}/XacNhanDonHang?orderId=${order.id}" class="func-btn accept-btn">Xác nhận đơn hàng</a>
                    </div>
                </div>
                        ...
                        <c:forEach var="orderDetail" items="${order.orderDetails}" varStatus="loop">
	                        <div class="product">
	                            ...
	                            <div class="product-option">
	                                ...
	                                <button type="button" class="func-btn del-prod" onclick="delProduct('${orderDetail.product.id}')">Xóa</button>
	                            </div>
	                        </div>
	                        <hr>
                        </c:forEach>
    ...
    <script>
        function delOrder() {
            if (window.confirm("Bạn chắc chắn muốn xóa?")) {
                window.location = "${pageContext.request.contextPath}/XoaDonHang?orderId=${order.id}";
            }
        }
    </script>
    ...
    <script>
        function delProduct(productId) {
            if (window.confirm("Bạn chắc chắn muốn xóa?")) {
                window.location = "${pageContext.request.contextPath}/XoaSanPhamTrongDonHang?orderId=${order.id}&productId=" + productId;
            }
        }
    </script>
	...
	<c:if test="${updateOrderError == true || deleteProductError == true || acceptOrderError == true}">
	    <script>
