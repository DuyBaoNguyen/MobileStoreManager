...
<body>
            ...
            <div class="left-menu">
                ...
                <div class="panel">
                    <div class="menu-item-container">
                        ...
                        <a href="${pageContext.request.contextPath}/BinhLuanDaTraLoi" class="menu-item" id="active-item">
                            Đã trả lời
                        </a>
                    </div>
                </div>
    ...
    <div class="top-nav">
        <h4 class="title">Bình luận đã trả lời</h4>
    </div>
    ...
    <script>
        function delComment(commentId) {
            if (window.confirm("Bạn chắc chắn muốn xóa?")) {
                window.location = "${pageContext.request.contextPath}/XoaBinhLuan?commentId=" + commentId + "&answerdComment=1";
            }
        }
    </script>

	<c:if test="${deleteCommentError == true}">
	    <script>
