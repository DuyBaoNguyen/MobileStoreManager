...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/list_order.css">
                ...
                <tbody>
                	<c:forEach var="order" items="${orders}">
	                    <tr>
	                        ...
	                        <td>${order.money}</td>
	                        <td>
	                            <button type="button" class="del-btn sub-func-btn" onclick="delOrder('${order.id}')">Xóa</button>
	                            <a href="${pageContext.request.contextPath}/ChiTietDonHangChuaThanhToan?orderId=${order.id}" class="choose-btn sub-func-btn">Xem</a>
	                        </td>
	                    </tr>
                	</c:forEach>
                </tbody>
    ...
    <script>
        function delOrder(orderId) {
            if (window.confirm("Bạn chắc chắn muốn xóa?")) {
                window.location = "${pageContext.request.contextPath}/XoaDonHang?orderId=" + orderId;
            }
        }
    </script>

	<c:if test="${deleteOrderError == true}">
	    <script>
