...
<body>
    ...
    <div class="top-nav">
        <h4 class="title">Sửa thông tin tài khoản</h4>
    </div>
    <div class="main-container">
       	<div class="main-content">
            <form id="account-info" action="${pageContext.request.contextPath}/TaiKhoan/SuaTaiKhoan" method="post" accept-charset="UTF-8" onsubmit="return isValidForm()">
                <h5 class="sub-title">Username</h5>
                <input type="text" name="username" value="${account.username}" readonly autocomplete="off">
                
                <h5 class="sub-title">Tên người dùng</h5>
                <input type="text" name="displayName" value="${account.displayName}" required autocomplete="off">
                
                <h5 class="sub-title">Giới tính</h5>
                <label>
                	<input type="radio" name="sex" value="male"
                		<c:if test="${account.sex == true}">
                			checked
                		</c:if>
                	>
                	Nam
	...
	<c:if test="${updateAccountError == true}">
	    <script>
