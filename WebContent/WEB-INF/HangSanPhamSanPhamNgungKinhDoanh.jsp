...
<body>
    ...
    <div class="top-nav">
        <h4 class="title">Hãng sản phẩm ngừng kinh doanh</h4>
    </div>
    <div class="main-container">
        <div class="func-container">
         	<form action="${pageContext.request.contextPath}/SanPhamNgungKinhDoanh" method="get">
            ...
            <a href="${pageContext.request.contextPath}/SanPhamNgungKinhDoanh" class="func-btn nav-item">Làm mới</a>
        </div>
        <hr>
        <div class="main-content">
        	<c:forEach var="manuf" items="${manufs}">
	          	<div class="manuf-item-container">
	                <a href="${pageContext.request.contextPath}/SanPhamNgungKinhDoanh/HangSanPham?manufId=${manuf.id}" class="manuf-item">
	                    ${manuf.name}
	                </a>
	            </div>
         	</c:forEach>
