...
<body>
    ...
    <div class="main-container">
        <div class="main-content">
            <form action="${pageContext.request.contextPath}/SanPhamNgungKinhDoanh/SuaSanPham" method="post">
                <div class="img-container">
                    <div class="product-img">
                        <img id="image" src="data:image/jpeg;base64,${product.imageBase64}" alt="${product.name}" width="120" height="120">
                    </div>
                    <input id="imageBase64" type="hidden" name="productImageBase64" value="data:image/jpeg;base64,${product.imageBase64}">
				...
				<input type="hidden" name="manufId" value="${product.manufacturer.id}">

                <p class="sub-title">Tên điện thoại</p>
                <input type="text" name="productName" value="${product.name}" required autocomplete="off">
                
                <p class="sub-title">Giá</p>
                <input type="text" name="productPrice" value="${product.price}" required autocomplete="off">
                
                <p class="prod-info-title">Cấu hình</p>
                <p class="sub-title">Kích thước màn hình</p>
                <input type="text" name="productScreenSize" value="${product.screenSize}" autocomplete="off">
                
                <p class="sub-title">Công nghệ màn hình</p>
                <input type="text" name="productScreenTechnology" value="${product.screenTechnology}" autocomplete="off">
                
                <p class="sub-title">Hệ điều hành</p>
                <input type="text" name="productOs" value="${product.os}" autocomplete="off">
                
                <p class="sub-title">Camera trước</p>
                <input type="text" name="productFrontCamera" value="${product.frontCamera}"  autocomplete="off">
                
                <p class="sub-title">Camera sau</p>
                <input type="text" name="productPosteriorCamera" value="${product.posteriorCamera}" autocomplete="off">
                
                <p class="sub-title">CPU</p>
                <input type="text" name="productCpu" value="${product.cpu}" autocomplete="off">
                
                <p class="sub-title">RAM</p>
                <input type="text" name="productRam" value="${product.ram}" autocomplete="off">
                
                <p class="sub-title">Bộ nhớ trong</p>
                <input type="text" name="productInternalMemory" value="${product.internalMemory}" autocomplete="off">
                
                <p class="sub-title">Thẻ nhớ</p>
                <input type="text" name="productMemoryStick" value="${product.memoryStick}" autocomplete="off">
                
                <p class="sub-title">Thẻ sim</p>
                <input type="text" name="productSim" value="${product.sim}" autocomplete="off">
                
                <p class="sub-title">Dung lượng pin</p>
                <input type="text" name="productPin" value="${product.pin}" autocomplete="off">
                
                <p class="sub-title">Màu sắc</p>
                <input type="text" name="productColors" value="${product.colorsString}" required autocomplete="off">
                
                <p class="prod-info-title">Tính năng</p>
                <label class="func-item">
                    <input type="checkbox" name="waterproof" 
                    	<c:if test="${product.waterproof == true}">
                    		checked
                    	</c:if>
                    >
                    Chống nước
                ...
                <label class="func-item">
                    <input type="checkbox" name="dualCamera"
                    	<c:if test="${product.dualCamera == true}">
                    		checked
                    	</c:if>
                    >
                    Camera kép
                ...
                <label class="func-item">
                    <input type="checkbox" name="fastCharging"
                    	<c:if test="${product.fastCharging == true}">
                    		checked
                    	</c:if>	
                    >
                    Sạc pin nhanh
                ...
                <label class="func-item">
                    <input type="checkbox" name="faceSecurity"
                    	<c:if test="${product.faceSecurity == true}">
                    		checked
                    	</c:if>
                    >
                    Bảo mật khuôn mặt
                ...
                <label class="func-item">
                    <input type="checkbox" name="fingerprintSecurity"
                    	<c:if test="${product.fingerprintSecurity == true}">
                    		checked
                    	</c:if>
                    >
                    Bảo mật vân tay
	...
	<c:if test="${updateInactProductError == true}">
	    <script>
