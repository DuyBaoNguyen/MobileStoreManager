...
<body>
    ...
    <div class="top-nav">
        <h4 class="title">Sửa hãng sản phẩm</h4>
    </div>
    <div class="main-container">
        <div class="main-content">
            <form action="${pageContext.request.contextPath}/HangSanPham/SuaHangSanPham" method="post" accept-charset="UTF-8">
                <h5 class="sub-title">Tên hãng</h5>
                <input type="hidden" name="manufId" value="${manuf.id}">
                <input type="text" name="manufName" value="${manuf.name}" autofocus required autocomplete="off">
                <input type="submit" class="save-btn func-btn" value="Lưu">
            </form>
        </div>
    </div>
    
	<c:if test="${updateManufError == true}">
	    <script>
