...
<body>
            ...
            <div class="left-menu">
                ...
                <div class="panel">
                    <div class="menu-item-container">
                        <a href="${pageContext.request.contextPath}/SanPhamHot" class="menu-item" id="active-item">
                            Sản phẩm hot
                        </a>
    ...
    <div class="main-container">
        <div class="func-container">
         	<form action="${pageContext.request.contextPath}/SanPhamHot" method="get">
            ...
            <a href="${pageContext.request.contextPath}/SanPhamHot" class="func-btn nav-item">Làm mới</a>
        </div>
        <hr>
        <div class="main-content">
        	<h5>Danh sách sản phẩm hot</h5>
            <table id="hot-products" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        <th>Tên sản phẩm</th>
                        <th></th>
                ...
                <tbody>
                	<c:forEach var="hotProduct" items="${hotProducts}">
	                    <tr>
	                        ...
	                        <td>
	                            <button type="button" class="del-btn sub-func-btn" onclick="delHotProduct('${hotProduct.id}')">Xóa</button>
	                        </td>
	                    </tr>
                	</c:forEach>
                </tbody>
                ...
                <tbody>
                	<c:forEach var="product" items="${products}">
	                    <tr>
	                        <td>${product.name}</td>
	                        <td>
	                            <a href="${pageContext.request.contextPath}/SanPhamHot/ThemSanPhamHot?productId=${product.id}" class="choose-btn sub-func-btn">Chọn</a>
	                        </td>
	                    </tr>
                	</c:forEach>
                </tbody>
    ...
    <script>
        function delHotProduct(productId) {
            if (window.confirm("Bạn chắc chắn muốn xóa?")) {
                window.location = "${pageContext.request.contextPath}/SanPhamHot/XoaSanPhamHot?productId=" + productId;
            }
        }
    </script>

	<c:if test="${deleteHotProductError == true || insertHotProductError == true}">
	    <script>
