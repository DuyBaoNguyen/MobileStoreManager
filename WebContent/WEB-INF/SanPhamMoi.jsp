...
<body>
            ...
            <div class="left-menu">
                ...
                <div class="panel">
                    <div class="menu-item-container">
                        ...
                        <a href="${pageContext.request.contextPath}/SanPhamMoi" class="menu-item" id="active-item">
                            Sản phẩm mới
                        </a>
                    </div>
                </div>
    ...
    <div class="main-container">
        <div class="func-container">
         	<form action="${pageContext.request.contextPath}/SanPhamMoi" method="get">
            ...
            <a href="${pageContext.request.contextPath}/SanPhamMoi" class="func-btn nav-item">Làm mới</a>
        </div>
        <hr>
        <div class="main-content">
        	<h5>Danh sách sản phẩm mới</h5>
            <table id="new-products" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        <th>Tên sản phẩm</th>
                        <th></th>
                ...
                <tbody>
                	<c:forEach var="newProduct" items="${newProducts}">
	                    <tr>
	                        ...
	                        <td>
	                            <button type="button" class="del-btn sub-func-btn" onclick="delNewProduct('${newProduct.id}')">Xóa</button>
	                        </td>
	                    </tr>
                	</c:forEach>
                </tbody>
                ...
                <tbody>
                	<c:forEach var="product" items="${products}">
	                    <tr>
	                        <td>${product.name}</td>
	                        <td>
	                            <a href="${pageContext.request.contextPath}/SanPhamMoi/ThemSanPhamMoi?productId=${product.id}" class="choose-btn sub-func-btn">Chọn</a>
	                        </td>
	                    </tr>
                	</c:forEach>
                </tbody>
    ...
    <script>
        function delNewProduct(productId) {
            if (window.confirm("Bạn chắc chắn muốn xóa?")) {
                window.location = "${pageContext.request.contextPath}/SanPhamMoi/XoaSanPhamMoi?productId=" + productId;
            }
        }
    </script>

	<c:if test="${deleteNewProductError == true || insertNewProductError == true}">
	    <script>
