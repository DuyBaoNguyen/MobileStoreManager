...
<body>
    ...
    <div class="top-nav">
        <h4 class="title">Thêm hãng sản phẩm</h4>
    </div>
    <div class="main-container">
        <div class="main-content">
            <form action="${pageContext.request.contextPath}/HangSanPham/ThemHangSanPham" method="post" accept-charset="UTF-8">
                <h5 class="sub-title">Tên hãng</h5>
                <input type="text" name="manufName" autofocus required autocomplete="off">
                <input type="submit" class="save-btn func-btn" value="Lưu">
            </form>
        </div>
    </div>
    
	<c:if test="${insertManufError == true}">
	    <script>
