...
<body>
    ...
    <div class="main-container">
    	<ul class="breadcrumb">
	        <li><a href="${pageContext.request.contextPath}/SanPhamDangKinhDoanh">Hãng sản phẩm</a></li>
	        <li class="active">${manuf.name}</li>
       	</ul>
        <div class="func-container">
         	<form action="${pageContext.request.contextPath}/SanPhamDangKinhDoanh/HangSanPham" method="get">
			...
			<a href="${pageContext.request.contextPath}/SanPhamDangKinhDoanh/ThemSanPham?manufId=${manuf.id}" class="func-btn nav-item">Thêm</a>
            <a href="${pageContext.request.contextPath}/SanPhamDangKinhDoanh/HangSanPham?manufId=${manuf.id}" class="func-btn nav-item">Làm mới</a>
        </div>
        <hr>
        	...
        	<c:forEach var="product" items="${manuf.products}">
          	 	<div class="prod-item-container">
	                <div class="prod-item">
                        ...
                        <button type="button" onclick="delProduct('${product.id}')" class="del-btn sub-func-btn">Xóa</button>
	                	<a class="choose-btn sub-func-btn" href="${pageContext.request.contextPath}/SanPhamDangKinhDoanh/SuaSanPham?productId=${product.id}">Xem</a>
                    </div>
	            </div>
         	</c:forEach>
        </div>
    ...
    <script>
        function delProduct(productId) {
            if (window.confirm("Bạn chắc chắn muốn xóa?")) {
                window.location = "${pageContext.request.contextPath}/SanPhamDangKinhDoanh/XoaSanPham?manufId=${manuf.id}&productId=" + productId;
            }
        }
    </script>
    
    <c:if test="${deleteProductError == true}">
	    <script>
