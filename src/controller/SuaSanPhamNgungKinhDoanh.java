...
public class SuaSanPhamNgungKinhDoanh extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (updateInactProductError == true) {
			...
			response.sendRedirect(request.getContextPath() + "/SanPhamNgungKinhDoanh/SuaSanPham?productId=" + product.getId());
		}
		else {
			response.sendRedirect(request.getContextPath() + "/SanPhamNgungKinhDoanh/HangSanPham?manufId=" + manuf.getId());
		}
	}
